...
Please note that we do not possess ownership of the data. Researchers wishing to obtain data for further investigation or as part of this tutorial are obliged to request the data from the [Emote Database](https://emotedatabase.com/datasets/?page=2).
